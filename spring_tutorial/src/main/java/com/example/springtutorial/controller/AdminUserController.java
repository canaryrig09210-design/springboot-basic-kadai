...
//    localhost;8080/adminuserを実行したときに下記関数が呼び出される
//    引数modelにはviewの情報がすべて詰まっている
    public String adminUser(Model model) {
        // 最新のユーザーリストを取得
//    	①userserviceクラスの中のgetAllUsersメソッドを呼び出している
        List<User> users = userService.getAllUsers();

        // ビューにユーザーリストを渡す
//      ③戻り値に記載のadminUserView.htmlの中にある"users1"変数の中にusersの値を渡している
